...
const GROUPS: NavGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { to: "/settings/aws-credentials", label: "AWS Credentials", icon: KeyRound },
            { to: "/settings/worker-profiles", label: "Worker Profiles", icon: SlidersHorizontal },
            {
                to: "/settings/provisioning-templates",
                label: "Provisioning Templates",
                icon: ServerCog,
            },
            { to: "/settings/provisioning-policy", label: "Provisioning Policy", icon: Gauge },
            { to: "/settings/releases", label: "Releases", icon: PackageOpen },
